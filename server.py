...
def contains_end_of_message(message, end_sequence):
    if end_sequence.encode() == message[(len(message) - len(end_sequence)):len(message)]:
        return True
    else:
        return False
...
while True:
    ...
    received_message = receive_full_mesage(connection_socket, buff_size, end_of_message)
